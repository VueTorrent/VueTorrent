  ...
  <div class="pa-3">
      ...
      <v-col>
        <div class="d-flex justify-end">
          ...
          <v-btn icon variant="plain" color="primary">
            ...
            <PluginManagerDialog v-if="pluginManagerDialogVisible"
                                 v-model="pluginManagerDialogVisible" />
          </v-btn>
    ...
    <v-row class="ma-0 pa-0">
      <v-container class="d-flex align-center justify-center ma-0 pa-0 bg-primary" fluid>
        ...
        <v-btn icon="mdi-plus-circle-outline"
               ...
               color="accent"
               @click="createNewTab" />
        <v-btn icon="mdi-minus-circle-outline"
               variant="plain"
               color="error"
    ...
    <v-list>
      <v-list-item>
        <v-row class="mt-1">
          <v-col cols="12" md="6">
            <v-text-field v-model="selectedTab.query"
                          ref="queryInput"
                          autofocus
                          density="compact"
                          hide-details
          ...
          <v-col cols="6" sm="5" md="2">
            <v-select v-model="selectedTab.filters.category"
                      height="1"
                      variant="outlined"
                      density="compact"
                      hide-details
          ...
          <v-col cols="6" sm="5" md="2">
            <v-select v-model="selectedTab.filters.plugin"
                      flat
                      density="compact"
                      hide-details
                      variant="outlined"
      ...
      <v-list-item>
        <v-data-table :headers="headers"
          ...
          <template v-slot:top>
            <v-row>
              <v-col cols="12">
                <v-text-field v-model="selectedTab.filters.title"
                              density="compact"
                              hide-details
          ...
          <template v-slot:item.actions="{ item }">
            <v-btn icon="mdi-download"
                   variant="flat"
                   density="compact"
                   @click="downloadTorrent(item.raw)">
            </v-btn>
          </template>
        </v-data-table>
      </v-list-item>
