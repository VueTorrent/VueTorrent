...
import ItemAmount from '@/components/Dashboard/Views/List/DashboardItems/ItemAmount.vue'
import ItemChip from '@/components/Dashboard/Views/List/DashboardItems/ItemChip.vue'
import ItemData from '@/components/Dashboard/Views/List/DashboardItems/ItemData.vue'
import ItemDateTime from '@/components/Dashboard/Views/List/DashboardItems/ItemDateTime.vue'
import ItemDuration from '@/components/Dashboard/Views/List/DashboardItems/ItemDuration.vue'
import ItemPercent from '@/components/Dashboard/Views/List/DashboardItems/ItemPercent.vue'
import ItemRelativeTime from '@/components/Dashboard/Views/List/DashboardItems/ItemRelativeTime.vue'
import ItemSpeed from '@/components/Dashboard/Views/List/DashboardItems/ItemSpeed.vue'
import ItemText from '@/components/Dashboard/Views/List/DashboardItems/ItemText.vue'
