  ...
  <v-card flat>
    ...
    <v-list-item>
      <v-row>
        ...
        <v-col cols="6">
          <v-text-field v-model="settings.web_ui_password" outlined dense hide-details="true" :label="$t('modals.settings.webUI.authentication.password')" persistent-placeholder :placeholder="$t('modals.settings.webUI.authentication.passwordPlaceholder')" />
        </v-col>
      </v-row>
    </v-list-item>
    ...
    <v-list-item>
      <v-checkbox
        ...
        hide-details
        class="ma-0 pa-0"
        :label="$t('modals.settings.webUI.authentication.bypassWhitelist')"
      />
    </v-list-item>
    ...
    <v-list-item>
      <v-text-field v-model="settings.web_ui_ban_duration" class="mb-5" outlined dense type="number" hide-details="true" :label="$t('modals.settings.webUI.authentication.banDuration')" />
    </v-list-item>
    ...
    <v-list-item>
      <v-checkbox
          v-model="settings.use_https"
          hide-details
          class="ma-0 pa-0"
          :label="$t('modals.settings.webUI.https.subheader')"
      />
    </v-list-item>

    <v-list-item>
      <v-text-field :disabled="!settings.use_https" v-model="settings.web_ui_https_cert_path" class="mb-4" outlined dense hide-details :label="$t('modals.settings.webUI.https.certificate')" />
    </v-list-item>
    ...
    <v-list-item>
      <v-checkbox
          v-model="settings.web_ui_clickjacking_protection_enabled"
          hide-details
          class="ma-0 pa-0"
          :label="$t('modals.settings.webUI.security.clickjacking')"
      />
    </v-list-item>

    <v-list-item>
      <v-checkbox
          v-model="settings.web_ui_csrf_protection_enabled"
          hide-details
          class="ma-0 pa-0"
          :label="$t('modals.settings.webUI.security.csrf')"
      />
    </v-list-item>
    ...
    <v-list-item>
      <v-checkbox
          v-model="settings.web_ui_host_header_validation_enabled"
          hide-details
          class="ma-0 pa-0"
          :label="$t('modals.settings.webUI.security.hostHeaderValidation')"
      />
    </v-list-item>
    <v-list-item>
      <v-textarea
    ...
    <v-list-item>
      <v-checkbox
          v-model="settings.web_ui_use_custom_http_headers_enabled"
          hide-details
          class="ma-0 pa-0"
          :label="$t('modals.settings.webUI.customHeaders')"
      />
    </v-list-item>
    <v-list-item>
      <v-textarea
    ...
    <v-list-item>
      <v-checkbox
          v-model="settings.web_ui_reverse_proxy_enabled"
          hide-details
          class="ma-0 pa-0"
          :label="$t('modals.settings.webUI.reverseProxySupport')"
      />
    </v-list-item>
    <v-list-item>
      <v-text-field
    ...
    <v-list-item>
      <v-checkbox
          v-model="settings.dyndns_enabled"
          hide-details
          class="ma-0 pa-0"
          :label="$t('modals.settings.webUI.dynDns.subheader')"
      />
    </v-list-item>
    ...
    <v-list-item class="mb-4">
      <v-text-field
          :disabled="!settings.dyndns_enabled"
          v-model="settings.dyndns_domain"
          dense
          hide-details
          outlined
          :label="$t('modals.settings.webUI.dynDns.domainName')"
      />
    </v-list-item>
    ...
    <v-list-item>
      <v-row>
        <v-col cols="12" md="6">
          <v-text-field :disabled="!settings.dyndns_enabled" v-model="settings.dyndns_username" outlined dense hide-details="true" :label="$t('modals.settings.webUI.dynDns.username')" />
        </v-col>
        <v-col cols="12" md="6">
          <v-text-field :disabled="!settings.dyndns_enabled" v-model="settings.dyndns_password" outlined dense hide-details="true" :label="$t('modals.settings.webUI.dynDns.password')" />
        </v-col>
      </v-row>
    </v-list-item>
  </v-card>
