...
const comparatorMap: Record<keyof Torrent, (a: Torrent, b: Torrent, isAsc: boolean) => number> = {
  ...
  completed: (a, b, isAsc) => comparators.numeric.compare(a.completed, b.completed, isAsc),
  ...
  max_inactive_seeding_time: (a, b, isAsc) => comparators.numeric.compare(a.max_inactive_seeding_time, b.max_inactive_seeding_time, isAsc),
  max_ratio: (a, b, isAsc) => comparators.numeric.compare(a.max_ratio, b.max_ratio, isAsc),
  max_seeding_time: (a, b, isAsc) => comparators.numeric.compare(a.max_seeding_time, b.max_seeding_time, isAsc),
