        ...
        const busyTorrentProperties = computed<TorrentProperty[]>({
            get() {
                ...
                for (const [k, v] of Object.entries(busyProperties.value)) {
                    formattedPpt[v.order] = {
                        active: v.active,
                        name: k as DashboardProperty,
                        order: v.order,
                        props: propsMetadata[k].props,
                        type: propsMetadata[k].type
                    }
                }
                return formattedPpt
            },
            set(value) {
                value.forEach((ppt, index) =>  {
                    ...
                    busyProperties.value[ppt.name].order = index
                })
            }
        })
        const doneTorrentProperties = computed<TorrentProperty[]>({
            ...
            set(value) {
                value.forEach((ppt, index) =>  {
                    ...
                    doneProperties.value[ppt.name].order = index
                })
            }
        })
